...
def processar_arquivo(caminho_arquivo):
    try:
        ...
        # Exibir resultados
        print("Valores distintos da coluna N por intervalos de placas:")
                    ...
                    for rodada, selecoes in rodadas[intervalo_encontrado].items():
                        for selecao_info in selecoes:
                            if selecao_info["seleção"] == selecao_atual:
                                ...
                                # Preenche a coluna O com o valor da rodada
...
def selecionar_arquivo():
    caminho_arquivo = filedialog.askopenfilename(filetypes=[("Arquivo Excel", "*.xlsx")])
    if caminho_arquivo:
